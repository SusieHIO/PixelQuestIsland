...
class Game:
    ...
    def display_question(self, question):
        ...
        # Oppdater svaralternativene i knappene
    ...
    def win_game(self):
        print("Congratulations! You won and found the Treasure!")
        self.window.destroy()  # Lukker tkinter-vinduet når spillet er over
